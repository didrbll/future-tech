...
class Select extends BaseComponent {
  ...
  constructor(rootElement) {
    ...
    this.allOptionElements = this.dropdownElement.querySelectorAll(this.selectors.option);

    this.state = this.getProxyState({
      ...this.initialState,
      currentOptionIndex: this.originalControlElement.selectedIndex,
      selectedOptionElement: this.allOptionElements[this.originalControlElement.selectedIndex],
    })
  ...
  updateUI() {
    ...
    const updateButton = () => {
      ...
      this.buttonElement.setAttribute(
        ...
        this.allOptionElements[currentOptionIndex].id
      )
    }
    ...
    const updateOptions = () => {
      this.allOptionElements.forEach((optionElement, index) => {
        ...
        optionElement.setAttribute(this.stateAttributes.ariaActiveDescendant, isCurrent)
      })
    }
  ...
  selectCurrentOption() {
    this.state.selectedOptionElement = this.allOptionElements[this.state.currentOptionIndex]
  }
  ...
  onClick = (event) => {
    ...
    if (isOptionClick) {
      ...
      this.state.currentOptionIndex = [...this.allOptionElements].findIndex((optionElement) =>
  ...
  onArrowDownKeyDown = () => {
    ...
    if (this.state.currentOptionIndex < this.allOptionElements.length - 1) {
      this.state.currentOptionIndex++
    }
  }
  ...
  onOriginalControlChange = () => {
    this.state.selectedOptionElement = this.allOptionElements[this.originalControlElement.selectedIndex]
  }
